...
import { ArrowDown, Download, Github, Linkedin, Mail, Code, Sparkles } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl">
              ...
              Passionate about clean code, performance, and innovative solutions that make a difference.
            </p>
            ...
            <div className="flex gap-4 pt-4">
              <Button variant="ghost" size="icon" className="hover:scale-110 transition-transform hover:shadow-glow">
                ...
                <div className="space-y-4">
                  ...
                  <div className="font-mono text-sm space-y-2">
                     <div className="text-muted-foreground">
                       <span className="text-primary">function</span> createAmazingUI() &#123;
                     </div>
                     ...
                     <div className="text-muted-foreground pl-12">
                       quality=<span className="text-green-400">"exceptional"</span>
                     </div>
                     <div className="text-muted-foreground pl-12">
