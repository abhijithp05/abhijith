...
export function About() {
  const highlights = [
    ...
    },
    {
      ...
      description:
        "Leading cross-functional teams to deliver outstanding results",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                With about 8 years of experience in frontend development, I
                specialize in creating responsive, accessible, and
                high-performance web applications. My expertise spans across
                modern JavaScript frameworks, with a particular passion for
                React and Next.js.
              </p>

              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                I believe in the power of great user experience and clean,
                maintainable code. My approach combines technical excellence
